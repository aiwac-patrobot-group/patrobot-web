    ...
    export default {
        ...
        created () {
          ...
          if(user != null && user.name != ""){
            this.ruleForm2.username = user.userAccount;
        ...
        methods: {
            ...
            handleSubmit2(ev) {
                ...
                this.$refs.ruleForm2.validate((valid) => {
                  if (valid){
                    this.$axios.post("/admin/login", {username:this.ruleForm2.username,password:this.ruleForm2.checkPass})
                      .then(data => {
                        // 登录失败,先不讨论
                        if (data.status != 200) {
                          ...
                          if (data.data.errorCode == '200'){
                            ...
                            if (this.checked === true){
                              ...
                              this.userApi.setUserCookie(this.ruleForm2.username, this.ruleForm2.checkPass, 7, true);
                            }else {
                              // 删除cookie
